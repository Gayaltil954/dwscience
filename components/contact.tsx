          ...
          <div className="p-8 sm:p-12 flex flex-col justify-between relative overflow-hidden" style={{ backgroundColor: '#FFCC07' }}>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4 animate-fade-in-up hover:translate-x-2 transition-transform duration-300" style={{ animationDelay: '300ms', animationFillMode: 'both' }}>
