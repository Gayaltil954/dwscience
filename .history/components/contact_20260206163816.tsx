          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-4 animate-fade-in-up" style={{ animationDelay: '500ms', animationFillMode: 'both' }}>
        <div className="p-2 rounded-lg bg-black/10">
          <MapPin className="w-6 h-6 shrink-0" style={{ color: '#000000' }} />
        </div>
        <div>
          <p className="font-semibold" style={{ color: '#000000' }}>Our Learning Centers</p>
