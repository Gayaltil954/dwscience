              ...
              <div className="relative h-[500px] lg:h-[600px] group">
                ...
                <div 
                  ...
                  style={{
                    ...
                    transition: 'clip-path 0.8s cubic-bezier(0.16, 1, 0.3, 1), box-shadow 0.6s ease-out'
                  }}
                >
                  {/* Zooming image */}
                  <div 
                    style={{
                      ...
                      transition: 'transform 0.8s cubic-bezier(0.16, 1, 0.3, 1), filter 0.6s ease-out'
                    }}
                  >
                    <Image
                      src="/Dili.jpeg"
            ...
            >
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      opacity: Math.max(0, (scrollProgress - index * 0.15) * 1.5),
                  ...
                  >
                    ...
                    <div 
                      ...
                      style={{
                        ...
                        transition: 'height 0.8s cubic-bezier(0.16, 1, 0.3, 1), opacity 0.4s ease-out'
                      }}
                    />
              ...
              >
                ...
                {[
                  ...
                  { label: 'Excellence', value: 'Top Rated', hasCounter: false }
                ].map((stat, index) => (
                  <div 
                    key={index}
                  ...
                  >
                    <div className="stat-value text-2xl font-bold text-yellow-600">
                      {stat.hasCounter && statsVisible ? `${countedValue}+` : stat.value}
                    </div>
                    <div className="stat-label text-sm text-muted-foreground mt-1">{stat.label}</div>
                  </div>
                ))}
              </div>
            </div>
