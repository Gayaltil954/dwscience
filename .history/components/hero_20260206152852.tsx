      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[calc(100vh-5rem)]">
          ...
          {/* <div className="flex flex-col justify-center space-y-6 md:space-y-8">
            ...
            <div className="flex flex-col justify-center space-y-6 md:space-y-8">
  <div>
    {/* Optimized H1: Includes Name + Main Subject + Primary Location */}
    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-foreground leading-tight text-balance">
      Science with <span className="text-blue-600">Dilini Weerakkody</span>
    </h1>
  </div>

  <div className="space-y-3">
    {/* Enhanced P tag: Strong keywords for Grade and Medium */}
    <p className="text-lg sm:text-xl text-foreground font-bold tracking-tight">
      English Medium Science Classes | Grades 6 – 11
    </p>

    {/* Location Keywords: This is what ranks the site in your specific areas */}
    <p className="text-base sm:text-lg text-muted-foreground font-medium leading-relaxed">
      Expert Tuition at <span className="font-semibold text-foreground">Sunray (Galle)</span>, 
      <span className="font-semibold text-foreground"> Zigma (Baddegama)</span>, and 
      <span className="font-semibold text-foreground"> Prinstent (Hirikumbura)</span>.
    </p>

    {/* Hidden SEO Helper: Only for screen readers and bots to strengthen the "Teacher" entity */}
