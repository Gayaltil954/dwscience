          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-8">
                ...
                >
                  <a href="mailto:diliniweerakkodi91@gmail.com" className="flex items-start gap-4 animate-fade-in-up hover:translate-x-2 transition-transform duration-300 group" style={{ animationDelay: '400ms', animationFillMode: 'both' }}>
        <div className="p-2 rounded-lg bg-black/10 group-hover:bg-black/20 transition-colors">
