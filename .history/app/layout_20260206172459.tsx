...
export const metadata: Metadata = {
  ...
  description:
    "Join Dilini Weerakkody for English-medium Science (Grades 6-11) at Sunray (Galle), Zigma (Baddegama), and Prinseton College (Hirikumbura). Enroll for 2026 batches.",
  generator: "v0.app",
