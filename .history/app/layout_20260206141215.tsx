...
export const metadata: Metadata = {
  ...
  description: 'Join Dilini Weerakkody for English-medium Science (Grades 6-11) at Sunray (Galle), Zigma (Baddegama), and Prinstent College (Hirikumbura). Enroll for 2026 batches.',
  generator: 'v0.app',
  ...
  openGraph: {
    ...
    siteName: 'dwscience',
    images: [{ url: '../public/Dilini-Weerakkody.jpeg' }], // Add a path to a photo of her or a lab
  },
